...
class ErrorInstance:
    ...
    def __init__(
        ...
        model_name_or_path = generator.model_or_name_or_path if isinstance(generator, GeneratorHFModel) else "gpt2"
        tokenize = False
        ...
        if all(isinstance(key, str) for key in self.datasets):
            ...
            if "bird" in self.datasets:
                ...
                combined_datasets.extend(bird_dataset.data)  # Assume the list property is called data_list
            ...
            if "spider" in self.datasets:
                ...
                combined_datasets.extend(spider_dataset.data)  # Assume the list property is called data_list
            ...
            if "domains" in self.datasets:
                ...
                combined_datasets.extend(domain_dataset.data)  # Assume the list property is called data_list
    ...
    def generate_and_save(self, force: Optional[bool]=False, path_to_save: Optional[str]=None):
        path_to_save = (self.generator.experiment_path / "error_dataset.json") if path_to_save is None else Path(path_to_save)
