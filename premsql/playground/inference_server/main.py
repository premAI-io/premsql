...
def create_app(args: argparse.Namespace) -> FastAPI:
    ...
    async def get_available_agents():
        return {
            "available_agents": agent_service.agents
        }
...
def parse_arguments():
    ...
    parser.add_argument("--include_tables", help="Comma-separated list of tables to include")
    parser.add_argument("--exclude_tables", help="Comma-separated list of tables to exclude")
    parser.add_argument("--host", default="127.0.0.1", help="Host to run the server on")
    parser.add_argument("--port", type=int, default=8500, help="Port to run the server on")
