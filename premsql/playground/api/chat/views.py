...
from .serializers import (
    ...
    ChatMessageCreationRequest, ChatMessageCreationResponse,
...
from .drf_serializers import (
    ...
    ChatMessageCreationRequestSerializer, ChatMessageCreationResponseSerializer,
    ChatMessageListRequestSerializer, ChatMessageListResponseSerializer,
    ChatMessageSummarySerializer
)
...
def create_chat_message(request):
    try:
        ...
        return Response(
            {"status": "error", "error_message": "Invalid JSON"}, status=status.HTTP_400_BAD_REQUEST
        )
    except Exception as e:
        return Response(
